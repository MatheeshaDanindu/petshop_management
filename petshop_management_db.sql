...
-- Dumping data for table petshop_db.inventory: ~0 rows (approximately)
...
-- Dumping data for table petshop_db.users: ~0 rows (approximately)
INSERT INTO `users` (`id`, `username`, `password_hash`, `email`, `phone_number`, `role`, `created_at`) VALUES
	(6, 'admin', '$2y$10$nm1t9mM.XqGFKlgxVBBjHOp2pp8Pi90tUHQTg6e8uy.9i8axGVSH6', 'admin@gmail.com', '1234567890', 'admin', '2024-08-26 04:18:07');
